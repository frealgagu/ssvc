...
public class ConfigurationWindow extends CustomComponent {
    ...
    @AutoGenerated
    private NativeButton btnPLCRegistersConfiguration;

    @AutoGenerated
    private NativeButton btnPLCConnectionConfiguration;
	...
	private void initialize() {
        ...
        btnPLCConnectionConfiguration.addListener(new Button.ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                PLCConnectionConfigurationDialog plcConnectionConfigurationDialog = new PLCConnectionConfigurationDialog();
                container.setContent(plcConnectionConfigurationDialog);
                getWindow().addWindow(container);
            }
        });
        btnPLCRegistersConfiguration.addListener(new Button.ClickListener() {
	...
	private AbsoluteLayout buildMainLayout() {
        ...
        // btnPLCConnectionConfiguration
        btnPLCConnectionConfiguration = new NativeButton();
        btnPLCConnectionConfiguration.setCaption("Conexi\u00F3n al PLC");
        btnPLCConnectionConfiguration.setIcon(new ThemeResource("img/plc-connection-settings-icon-72x72.png"));
        btnPLCConnectionConfiguration.setImmediate(true);
        btnPLCConnectionConfiguration.setWidth("86px");
        btnPLCConnectionConfiguration.setHeight("86px");
        mainLayout.addComponent(btnPLCConnectionConfiguration, "top:97.0px;left:40.0px;");

        // btnPLCRegistersConfiguration
        btnPLCRegistersConfiguration = new NativeButton();
        btnPLCRegistersConfiguration.setCaption("Registros del PLC");
        btnPLCRegistersConfiguration.setIcon(new ThemeResource("img/plc-registers-settings-icon-72x72.png"));
        btnPLCRegistersConfiguration.setImmediate(true);
        btnPLCRegistersConfiguration.setWidth("86px");
        btnPLCRegistersConfiguration.setHeight("86px");
        mainLayout.addComponent(btnPLCRegistersConfiguration, "top:97.0px;right:320.0px;");
		...
		mainLayout.addComponent(btnEmailConfiguration, "top:97.0px;left:320.0px;");
		...
		mainLayout.addComponent(btnNotificationConfiguration, "top:97.0px;right:40.0px;");
